...
require (
	...
	github.com/haproxytech/client-native/v5 v5.1.13
...
replace github.com/haproxytech/client-native/v5 => github.com/triplelift-internal/haproxy-client-native/v5 v5.1.3-triplelift-7-dev
